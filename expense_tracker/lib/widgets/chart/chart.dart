...
class _ChartState extends State<Chart> {
  ...
  List<ExpenseBucket> get buckets {
    return Category.values
        .map((category) => ExpenseBucket.forCategory(_chartExpenses, category))
        .toList();
  }
  ...
  double get totalExpense {
    double amt = 0;
    for (final exp in _chartExpenses) {
      amt += exp.amount;
    }
    return amt;
  }
                    ...
                    items: [
                      ...
                      DropdownMenuItem(
                        ...
                        child: Row(
                          children: [
                            Text(
                              'Specific Date: ${_specificDate == null ? '' : formatter.format(_specificDate!)}',
                              style: Theme.of(context)
                                  .textTheme
                                  .titleLarge!
                                  .copyWith(fontWeight: FontWeight.normal),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .titleLarge!
                          .copyWith(fontWeight: FontWeight.normal, fontSize: 14,decoration: TextDecoration.overline),
                    ),
                  ],
                )
              ],

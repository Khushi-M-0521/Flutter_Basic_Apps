    ...
    return MaterialApp(
      ...
      theme: ThemeData.light().copyWith(
        ...
        textTheme: const TextTheme().copyWith(
          ...
          labelLarge: TextStyle(color: kLightColorScheme.onSecondaryContainer,fontWeight: FontWeight.bold,fontSize: 15),
        ),
      ...
      darkTheme: ThemeData.dark().copyWith(
        ...
        textTheme: const TextTheme().copyWith(
          ...
          labelLarge: TextStyle(color: kDarkColorScheme.onSecondaryContainer,fontWeight: FontWeight.bold,fontSize: 15),
        ),
        cardTheme:const CardTheme().copyWith(elevation: 10,surfaceTintColor: Color.fromARGB(255, 45, 14, 243)),
        useMaterial3: true,
      ),

    ...
    return MaterialApp(
      ...
      theme: ThemeData.light().copyWith(
        ...
        textTheme: const TextTheme().copyWith(
          ...
          labelMedium: TextStyle(color: kLightColorScheme.onSecondaryContainer,fontWeight: FontWeight.bold),
        ),
      ...
      darkTheme: ThemeData.dark().copyWith(
        ...
        textTheme: const TextTheme().copyWith(
          ...
          labelMedium: TextStyle(color: kDarkColorScheme.onSecondaryContainer,fontWeight: FontWeight.bold),
        ),
